...
public class Run
{
    ...
    public IEnumerator Action { get => _action; }
    ...
    {
        var tmp = new Run();
        tmp._action = RunEvery(tmp, aInitialDelay, aDelay, 0, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunEvery(tmp, aInitialDelay, aDelay, count, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunAfter(tmp, aDelay, action);
        tmp.Start();
        return tmp;
    }
    ...
    */
    ...
    {
        var tmp = new Run();
        tmp._action = RunAfterRealtime(tmp, aDelay, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunAfterCoroutine(tmp, coroutine, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunNextFrame(tmp, action);
        tmp.Start();
        return tmp;
    }
    ...
    */
    ...
    {
        var tmp = new Run();
        tmp._action = RunNextFixedUpdate(tmp, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunWait(tmp, predict, action);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = RunCoroutine(tmp, coroutine);
        tmp.Start();
        return tmp;
    }
    ...
    {
        var tmp = new Run();
        tmp._action = this.WaitUntilDone(action);
        tmp.Start();
        return tmp;
    }
    ...
    protected void Start()
    {
        if (this._action != null)
            CoroutineHelper.Instance.StartCoroutine(this._action);
    }
