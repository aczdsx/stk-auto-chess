...
namespace CookApps.AutoBattler
{
    public partial class UserDataManager
    {
        ...
        public void IncreaseItem(int itemKey, int itemAmount, bool isSave, bool needUpdateReddot)
        {
            // switch (itemType)
            // {
            //     case ItemType.GOLD:
        ...
        public void DecreaseItem(int itemKey, int itemAmount, bool isSave, bool needUpdateReddot)
        {
            // switch (itemType)
            // {
            //     case ItemType.GOLD:
