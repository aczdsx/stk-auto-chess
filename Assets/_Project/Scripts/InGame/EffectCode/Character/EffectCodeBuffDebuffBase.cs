...
namespace CookApps.BattleSystem
{
    public abstract class EffectCodeBuffDebuffBase : EffectCodeCharacterBase
    {
        ...
        {
            // [TODO] : 영구적으로 걸리는 버프/디버프는 아이콘을 표시하지 않아야한다면 주석을 해제해주세요.
            // if (!Removable)
            //     return false;
            ...
            // [TODO] : src가 CharacterController가 아닌 경우(버프나 디버프를 주는게 캐릭터가 아닌 경우)가 있고, 이 경우에도 아이콘을 표시해야한다면 true를 반환하도록 구현해주세요.
        ...
        public virtual string GetBuffIconName()
        {
            ...
            // [TODO] : src가 CharacterController가 아닌 경우(버프나 디버프를 주는게 캐릭터가 아닌 경우)가 있고, 이 경우에도 아이콘을 표시해야한다면 아이콘 이름을 반환하도록 구현해주세요.
