...
[UseEffectCodeIds((int)CharacterEffectType.HP_PERCENT_UP)]
public class EffectCodeStatIncreaseHPPercent : EffectCodeStatBase
{
    ...
    public override double GetIncrementPercentHP()
    {
        return increment;
    }
}
