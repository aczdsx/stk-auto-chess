...
[UseEffectCodeIds((int)EffectCodeNameType.CRIT_RATE_UP)]
public partial class EffectCodeStatIncreaseCriticalRate : EffectCodeStatBase
{
    ...
    public override float GetIncrementFixedCriticalProbRate()
    {
        return increment;
    }
}
