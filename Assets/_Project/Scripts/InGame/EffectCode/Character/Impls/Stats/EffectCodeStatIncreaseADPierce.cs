...
[UseEffectCodeIds((int)EffectCodeNameType.AD_PIERCE_UP)]
// [UseEffectCodeIds(12)]
public partial class EffectCodeStatIncreaseADPierce : EffectCodeStatBase
{
    ...
    public override double GetIncrementFixedADPierce()
    {
        return increment;
    }
}
