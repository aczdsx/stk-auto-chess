...
/// </summary>
[UseEffectCodeIds(217523403)]
public partial class EffectCodeSkill217523403 : EffectCodeCharacterBase
{
        ...
        foreach (var tile in inGameTiles)
        {
            ...
            if (tile.CheckValidTile(owner.AllianceType, false))
            {
                if (!_hitCharacters.Exists(l => l == tile.OccupiedCharacter))
                {
                    ...
                    float damageRate = (float) (owner.AD * _damageRate) * (1.0f + (float) owner.ADReduce / _defValue);
