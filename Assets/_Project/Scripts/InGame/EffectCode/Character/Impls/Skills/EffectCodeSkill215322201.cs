...
// (최대 3명까지만 적용) "
/// </summary>
[UseEffectCodeIds(215322201)]
public partial class EffectCodeSkill215322201 : EffectCodeCharacterBase
{
            ...
            foreach (var tile in inGameTiles)
            {
                ...
                if (tile.CheckValidTile(owner.AllianceType, false))
                {
                    if (!targetCharacterList.Contains(tile.OccupiedCharacter.CharacterUId))
                    {
                        ...
                        EffectCodeHelper.AddOrMergeEffectCode(EffectCodeNameType.CC_KNOCKBACK, tile.OccupiedCharacter, eccStats, source);
                    }
                }
            }
        }
