...
public partial class EffectCodeDebuffAirborne : EffectCodeDebuffBase
{
    private const int CodeId = (int)EffectCodeNameType.DEBUFF_AIRBORNE;
    private const BuffDebuffType buffDebuffType = BuffDebuffType.Airborne;
