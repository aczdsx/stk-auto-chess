...
public partial class EffectCodeDebuffMisa : EffectCodeDebuffBase
{
    private const int CodeId = (int)EffectCodeNameType.DEBUFF_MISA;
    private const BuffDebuffType buffDebuffType = BuffDebuffType.Misa;
