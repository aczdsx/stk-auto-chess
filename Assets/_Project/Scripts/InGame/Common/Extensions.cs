    ...
    public static class InGameEnumExtensions
    {
        ...
        public static InGameVfxNameType GetOneShotVfxName(this BuffDebuffType type)
        {
            return type switch
            {
                ...
                BuffDebuffType.DefenceDown => InGameVfxNameType.fx_common_buff_dfdown,
                BuffDebuffType.Provocation => InGameVfxNameType.fx_common_buff_provoke,
                BuffDebuffType.HealDown => InGameVfxNameType.fx_common_buff_healdown,
        ...
        public static InGameVfxNameType GetLoopVfxName(this BuffDebuffType type)
        {
            return type switch
            {
                ...
                BuffDebuffType.DefenceDown => InGameVfxNameType.fx_common_buff_01,
                BuffDebuffType.HealDown => InGameVfxNameType.fx_common_buff_healdown_01,
