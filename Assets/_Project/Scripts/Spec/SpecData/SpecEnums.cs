...
namespace CookApps.AutoBattler
{
    ...
    public enum GuideMissionType
    {
        ...
        SUMMON_CHARCTER = 8,
        END_DIALOGUE = 9,
        LEVELUP_CHARACTER_TARGET = 10,
        SET_LV_CHARACTER_TARGET = 11,
        CLEAR_TRIAL = 12,
        SUM_CHARACTER_LEVEL = 13,
        SET_PVP_DEF_DECK = 14,
        PLAY_PVP = 15,
        CLICK_ATTENDANCE = 16,
        CLEAR_TUTORIAL = 17,
        ENTER_STAGE = 18,
        SUMMON_CHARACTER_NORMAL = 19,
        SUMMON_WEAPHON_NORMAL = 20,
        CLEAR_BABEL = 21,
        DIMENSION_CUBE_LEVEL = 22,
        ENTER_CHAPTER = 23,
        ENTER_ELPIS = 24,
        UPGRADE_BUILDING = 25,
        INSTALL_BUILDING = 26,
        EXCEED_CHARACTER_TARGET = 27,
        TRANSCENDENCE_CHARACTER_TARGET = 28,
        UPGRADE_DIMENSION_CUBE_CORE_RESEARCH = 29,
    }
