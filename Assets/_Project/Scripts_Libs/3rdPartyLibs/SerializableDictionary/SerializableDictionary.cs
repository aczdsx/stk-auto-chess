...
public abstract class SerializableDictionaryBase<TKey, TValue, TValueStorage> : SerializableDictionaryBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
{
	...
	public ICollection<TKey> Keys {	get { return ((IDictionary<TKey, TValue>)dict).Keys; } }
	public ICollection<TValue> Values { get { return ((IDictionary<TKey, TValue>)dict).Values; } }
	public int Count { get { return ((IDictionary<TKey, TValue>)dict).Count; } }
	public bool IsReadOnly { get { return ((IDictionary<TKey, TValue>)dict).IsReadOnly; } }

	public TValue this[TKey key]
	{
		get { return ((IDictionary<TKey, TValue>)dict)[key]; }
	...
	public bool IsFixedSize { get { return ((IDictionary)dict).IsFixedSize; } }
	...
	public bool IsSynchronized { get { return ((IDictionary)dict).IsSynchronized; } }
	public object SyncRoot { get { return ((IDictionary)dict).SyncRoot; } }
