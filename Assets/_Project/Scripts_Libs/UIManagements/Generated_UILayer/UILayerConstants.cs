    ...
    internal static class UILayerConstants
    {
        public static string GetUILayerAddress(string uiLayerName)
        {
            return uiLayerName switch
            {
                ...
                "ArenaMainPopup" => "Prefabs/UI/01_Pops/ArenaPopup/ArenaMainPopup.prefab",
                "ArenaPVPEndPopup" => "Prefabs/UI/01_Pops/ArenaPopup/ArenaPvpEndPopup.prefab",
                "BuyArenaPopup" => "Prefabs/UI/01_Pops/ArenaPopup/BuyArenaPopup.prefab",
                ...
                "ChapterClearWindowPopup_1" => "Prefabs/UI/01_Pops/WindowPopup/PvpDailyWindowPopup.prefab",
