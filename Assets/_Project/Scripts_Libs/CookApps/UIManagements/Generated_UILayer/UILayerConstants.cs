    ...
    internal static class UILayerConstants
    {
        public static string GetUILayerAddress(string uiLayerName)
        {
            return uiLayerName switch
            {
                ...
                "BattleDefeatCutsceneUI" => "Prefabs/UI/InGame/InGameBattleDefeatedOverlay.prefab",
                "BattleStartCutsceneUI" => "Prefabs/UI/InGame/InGameBattleStartOverlay.prefab",
                "BattleVictoryCutsceneUI" => "Prefabs/UI/InGame/InGameBattleVictoryOverlay.prefab",
