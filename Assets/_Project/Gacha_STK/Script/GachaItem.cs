...
namespace CookApps.AutoBattler
{
    public class GachaItem : MonoBehaviour
    {
        ...
        public void InitItem(Character _characterData, int _pieceCount, int idx, List<Character> datas)
        {
            ...
            SigmaImage.sprite = ImageManager.Instance.GetSprite(Defines.STIGMA_ATLAS_NAME, $"StigmaIcon_{_characterData.id}");
        }
        ...
        public void ChangeItem()
        {
            ...
            if (pieceCount == 20)
            {
                if (characterData.grade == Grade.COMMON)
                {
                ...
                else if (characterData.grade == Grade.RARE)
                {
                ...
                else if (characterData.grade == Grade.EPIC)
                {
                ...
                else if (characterData.grade == Grade.LEGEND)
                {
        ...
        public void ShowItem()
        {
            ...
            else
            {
                ...
                PieceOnImage.sprite = ImageManager.Instance.GetSprite("Atlas_Character_Inventory", characterData.id.ToString());
                // if (DataManager.Instance.UserData.isFirstGacha)
                // {
                //
                //     if (characterData.Level == 0)
