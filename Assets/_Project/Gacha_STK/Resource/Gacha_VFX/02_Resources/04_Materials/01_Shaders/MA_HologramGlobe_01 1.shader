...
Shader "Gacha/MA_HologramGlobe_02"
{
	Properties
	{
		...
		_T_Globe("T_Globe", 2D) = "white" {}
		_SuperNoise8512x512("Super Noise 8 - 512x512", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _T_Globe;
		uniform float4 _T_Globe_ST;
		uniform sampler2D _SuperNoise8512x512;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv_T_Globe = i.uv_texcoord * _T_Globe_ST.xy + _T_Globe_ST.zw;
			float4 tex2DNode31 = tex2D( _T_Globe, uv_T_Globe );
			float temp_output_40_0 = saturate( round( ( tex2DNode31.a * 2.0 ) ) );
			float4 temp_cast_0 = (temp_output_40_0).xxxx;
			float2 uv_TexCoord44 = i.uv_texcoord * float2( 0.5,0.5 );
			float2 panner43 = ( 1.0 * _Time.y * float2( 0.15,0.15 ) + uv_TexCoord44);
			float4 tex2DNode41 = tex2D( _SuperNoise8512x512, panner43 );
			float temp_output_46_0 = ( tex2DNode41.r * tex2DNode41.r );
			o.Emission = ( ( i.vertexColor * saturate( ( ( ( _Color_Fresnel * temp_output_17_0 ) + lerpResult13 ) - temp_cast_0 ) ) ) * temp_output_46_0 ).rgb;
			o.Alpha = ( ( i.vertexColor.a * saturate( ( ( ( temp_output_17_0 + tex2DNode1.a ) * (i.ASEIsFrontFacing > 0 ? +1 : -1 ) ) - temp_output_40_0 ) ) ) * temp_output_46_0 );
		}
...
Node;AmplifyShaderEditor.ColorNode;3;-1126.938,-277.5788;Inherit;False;Property;_Color_Main;Color_Main;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1.992675,2.923368,2.996078,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;15;-831.9437,-276.9495;Inherit;False;Property;_Color_Main2;Color_Main2;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.2783019,0.6297045,1,0.2392157;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-1383.078,88.07954;Inherit;True;Property;_Texture_Main;Texture_Main;3;0;Create;True;0;0;0;False;0;False;-1;None;5eb76050805d29c44aca0f54bc23d0ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;609.4034,-299.5772;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;35;239.9398,-132.2111;Inherit;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;41;976.0251,522.632;Inherit;True;Property;_SuperNoise8512x512;Super Noise 8 - 512x512;10;0;Create;True;0;0;0;False;0;False;-1;32c8311af713d3f4f87aac4bbdd73d06;4b39e0be71e3da540bedd37b3a0424d6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1509.406,-144.0747;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;Gacha/MA_HologramGlobe_02;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;2;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;False;4;1;False;;1;False;;0;5;False;;10;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;6;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.PannerNode;43;752.2324,456.4147;Inherit;False;3;0;FLOAT2;1,1;False;2;FLOAT2;0.15,0.15;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;1293.964,588.7215;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;31;-304.2234,734.3991;Inherit;True;Property;_T_Globe;T_Globe;9;0;Create;True;0;0;0;False;0;False;-1;b98230e600bc57d4f83e1a4f1771dd1b;b98230e600bc57d4f83e1a4f1771dd1b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;40.47368,824.02;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RoundOpNode;39;273.4736,820.02;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CeilOpNode;33;105.3559,585.4994;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;44;758.8224,316.5408;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.5,0.5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;697.0331,-31.01537;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;36;573.1058,96.39286;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;34;403.9854,202.4358;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;37;434.1745,-128.2541;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;1119.202,-279.6461;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;1347.066,249.3309;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;229.6211,373.9127;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;23;-544.0935,231.5176;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;13;-315.2393,-118.8335;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=13E7D1FFB94741327148180A3B428C190FF25B10