...
namespace Naninovel
{
    ...
    public class LocalizationManager : IStatefulService<SettingsStateMap>, ILocalizationManager
    {
        ...
        public LocalizationManager (LocalizationConfiguration config, IResourceProviderManager providersManager)
        {
            ...
            // choiJE.230621 bug fixed
            // SelectedLocale = Configuration.DefaultLocale;
        ...
        public virtual async UniTask LoadServiceStateAsync (SettingsStateMap stateMap)
        {
            ...
            await SelectLocaleAsync(defaultLocale);
        }
        ...
        {
            /*Debug.Log($"SelectLocaleAsync : SelectedLocaled = {SelectedLocale}, locale = {locale}");
            foreach(var s in AvailableLocales)
                Debug.Log("AvailableLocales : " + s);*/
        ...
        {
            Debug.Log("Configuration.Loader.PathPrefix : " + Configuration.Loader.PathPrefix);
