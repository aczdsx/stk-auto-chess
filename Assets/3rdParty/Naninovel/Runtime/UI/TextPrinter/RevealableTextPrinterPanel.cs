...
namespace Naninovel.UI
{
    ...
    public class RevealableTextPrinterPanel : UITextPrinterPanel
    {
        ...
        // added choiJE.230609. 캐릭터마다 색상 값 다르게 표시
        [SerializeField] private Image imageNameHeader;
        ...
        public override void OnAuthorChanged (string authorId, CharacterMetadata authorMeta)
        {
            ...
            if (imageNameHeader)
            {
                // imageNameHeader.enabled = !string.IsNullOrWhiteSpace(AuthorNameText);
                imageNameHeader.color = AuthorMeta.nameHeaderMarkColor;
            }
