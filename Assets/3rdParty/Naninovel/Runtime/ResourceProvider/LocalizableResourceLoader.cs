        ...
        where TResource : UnityEngine.Object
    {
        ...
        protected void InitializeProvisionSources ()
        {
            ...
            if (!LocalizationManager.IsSourceLocaleSelected() || !string.IsNullOrEmpty(overrideLocale))
            {
                ...
                // var localePrefix = string.IsNullOrEmpty(locale) ? $"{LocalizationManager.Configuration.Loader.PathPrefix}/{SourcePrefix}" : $"{LocalizationManager.Configuration.Loader.PathPrefix}/{locale}/{SourcePrefix}";
